...
if (receipt.schema !== "incidentmesh.provider-evidence/v1")
    throw new Error("unexpected provider receipt schema");
...
if (failed.length > 0)
    throw new Error(`stale-plan invariants failed: ${failed.map(([name]) => name).join(", ")}`);
